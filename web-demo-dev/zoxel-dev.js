...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'web-demo-dev/zoxel-dev.data';
      var REMOTE_PACKAGE_BASE = 'zoxel-dev.data';
...
Module['FS_createPath']("/Resources", "textures", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_web-demo-dev/zoxel-dev.data');

      };
      Module['addRunDependency']('datafile_web-demo-dev/zoxel-dev.data');
...
var ASM_CONSTS = {
 ...
 107607: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 107690: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 107759: () => { return window.innerWidth; },  
 107789: () => { return window.innerHeight; }
};
...
var ___stop_em_js = Module['___stop_em_js'] = 99663;
