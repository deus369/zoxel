...
echo_2 "  > copying [$local_properties_source] to [$local_properties_target]"
...
echo_2 "  > copying [$android_gradle_file_source] to [$android_gradle_file_target]"
...
echo_2 "  > copying [$android_manifesto_file] to [$android_manifesto_file_target]"
...
echo_2 "  > copying [$android_res_directory] to [$android_res_directory_target]"
...
echo_2 "  > copying [$file_1] to [$file_1_target]"
rm $file_1_target
...
echo_2 "  > copying [$file_2] to [$file_2_target]"
rm $file_2_target
...
echo_2 "  > copying [$file_3] to [$file_3_target]"
rm $file_3_target
