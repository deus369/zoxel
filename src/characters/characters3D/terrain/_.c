...
zox_begin_module(Characters3DTerrain)
    ...
    zox_system_1(Characters3DSpawnSystem, zox_pip_mainthread, [in] chunks.ChunkLodDirty, [in] chunks.ChunkOctree, [in] chunks.ChunkPosition, [in] rendering.RenderDistance, [in] rendering.RenderDisabled, [in] voxels.VoxLink, [out] generic.EntityLinks, [none] terrain.TerrainChunk)
