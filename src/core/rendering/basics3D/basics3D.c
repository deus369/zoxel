...
zox_render3D_system(RenderCharacters3DSystem, [none] MeshColorRGBs, [in] Position3D, [in] Rotation3D, [in] Scale1D, [in] MeshIndicies, [in] MeshGPULink, [in] ColorsGPULink, [none] !UvsGPULink)
