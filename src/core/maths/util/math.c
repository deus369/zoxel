...
float calculate_determinant(const float4x4 matrix) {
    return matrix.x.x * (matrix.y.y * (matrix.z.z * matrix.w.w - matrix.z.w * matrix.w.z) - matrix.y.z * (matrix.z.y * matrix.w.w - matrix.z.w * matrix.w.y) + matrix.y.w * (matrix.z.y * matrix.w.z - matrix.z.z * matrix.w.y))
                - matrix.x.y * (matrix.y.x * (matrix.z.z * matrix.w.w - matrix.z.w * matrix.w.z) - matrix.y.z * (matrix.z.x * matrix.w.w - matrix.z.w * matrix.w.x) + matrix.y.w * (matrix.z.x * matrix.w.z - matrix.z.z * matrix.w.x))
                + matrix.x.z * (matrix.y.x * (matrix.z.y * matrix.w.w - matrix.z.w * matrix.w.y) - matrix.y.y * (matrix.z.x * matrix.w.w - matrix.z.w * matrix.w.x) + matrix.y.w * (matrix.z.x * matrix.w.y - matrix.z.y * matrix.w.x))
                - matrix.x.w * (matrix.y.x * (matrix.z.y * matrix.w.z - matrix.z.z * matrix.w.y) - matrix.y.y * (matrix.z.x * matrix.w.z - matrix.z.z * matrix.w.x) + matrix.y.z * (matrix.z.x * matrix.w.y - matrix.z.y * matrix.w.x));
}
