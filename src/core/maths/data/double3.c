...
static inline double3 double3_mul(const double3 a, const double m) {
    return (double3) { a.x * m, a.y * m, a.z * m };
}

static inline double3 double3_divide_double(const double3 input, const double div) {
    return (double3) { input.x / div, input.y / div, input.z / div };
}

static inline double3 double3_normalize(const double3 input) {
