...
const CameraSpawnData camera_preset_first_person = { .position = (float3) { 0, 0.96f * 0.25f, 0.34f * 0.25f }, .euler = (float3) { 0, 180, 0 }, .fov = 90, .follow_mode = zox_camera_follow_mode_attach };
