...
void define_systems_cameras(ecs_world_t *world) {
    zox_system(Camera2DFollowSystem, EcsPostUpdate,
        [in] cameras.CameraMode,
        [in] CameraTarget,
        [out] transforms3.d.Position3D,
        [out] transforms3.d.Rotation3D,
        [none] CameraFollower2D)
    zox_system(Camera3DFollowSystem, EcsOnUpdate,
        [in] CameraFollowLink,
        [in] transforms3.d.LocalPosition3D,
        [out] transforms3.d.Position3D)
