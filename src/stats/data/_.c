...
const byte stat_index_soul = 0;
const byte stat_index_health = 1;
// we can remove this later, but will need to set a color on each stat for the bars
const byte stat_index_mana = 2;
const byte stat_index_energy = 3;