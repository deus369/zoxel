...
ecs_entity_t spawn_statbar2D(ecs_world_t *world, const ecs_entity_t canvas, const ecs_entity_t parent, const ecs_entity_t player, const ecs_entity_2 character_group, int row) {
    ...
    if (row == 1) {
        back_color = (color) { back_bar_color.g, back_bar_color.r, back_bar_color.b, back_bar_color.a };
    } else if (row == 2) {
        back_color = (color) { back_bar_color.b, back_bar_color.g, back_bar_color.r, back_bar_color.a };
    }
    color front_color = front_bar_color;
    if (row == 1) {
        front_color = (color) { front_bar_color.g, front_bar_color.r, front_bar_color.b, front_bar_color.a };
    } else if (row == 2) {
        front_color = (color) { front_bar_color.b, front_bar_color.g, front_bar_color.r, front_bar_color.a };
    }
