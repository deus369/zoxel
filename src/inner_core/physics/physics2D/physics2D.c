...
zoxel_system(Friction2DSystem, EcsOnUpdate, [none] physics.Frictioned, [in] Velocity2D, [out] Acceleration2D)
zoxel_system(Acceleration2DSystem, EcsOnUpdate, [out] Velocity2D, [out] Acceleration2D)
zoxel_system(Velocity2DSystem, EcsOnUpdate, [out] Position2D, [in] Velocity2D)
zoxel_system(Torque2DSystem, EcsOnUpdate, [out] Rotation2D, [in] Torque2D)
zoxel_system(Bounds2DSystem, EcsOnUpdate, [out] Position2D, [in] Bounds2D)
