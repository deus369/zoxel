...
#define bounce_multiplier 3.0f
#define bounce_lost_force 0.3f
...
zoxel_system(world, BasicCollision3DSystem, EcsPostUpdate, [in] voxels.ChunkLink, [out] Position3D, [out] Velocity3D, [out] voxels.VoxelPosition)
