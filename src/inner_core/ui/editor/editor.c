...
zox_system_1(HierarchyRefreshSystem, main_thread_pipeline, [none] HierarchyUI, [in] Position2D, [in] Layer2D, [in] ListUIMax, [in] ElementFontSize, [out] HierarchyUIDirty, [out] PixelSize, [out] TextureSize, [out] Children)
