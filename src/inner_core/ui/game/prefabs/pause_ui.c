...
ecs_entity_t spawn_prefab_pause_ui(ecs_world_t *world)
{
    ...
    ecs_set_name(world, e, "prefab_pause_ui");
...
ecs_entity_t spawn_pause_ui(ecs_world_t *world, const char *header_label,
    int2 position, int2 window_size, float2 anchor, unsigned char is_close_button)
{
