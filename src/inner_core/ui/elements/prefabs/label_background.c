...
ecs_entity_t spawn_label_background(ecs_world_t *world, const ecs_entity_t prefab, const ecs_entity_t parent, const ecs_entity_t canvas, int2 pixel_position, const float2 anchor, const byte2 padding, const char* text, const unsigned char font_size, const unsigned char alignment, const unsigned char layer, const int2 parent_pixel_position_global, const int2 parent_pixel_size, const color label_font_outline_color, const color label_font_fill_color) {
    ...
    // anchor_element_position2D(&pixel_position, anchor, pixel_size); // mesh gets repositioned by alignment apparently
    ...
    ZextSpawnData zextSpawnData = {
        ...
        .element = { .layer = layer, .position = pixel_position, .anchor = anchor },
        .prefab = prefab,
        .text = text,
        .font_size = font_size,
        .alignment = alignment,
