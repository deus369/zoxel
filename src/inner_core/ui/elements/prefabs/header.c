...
ecs_entity_t spawn_header(ecs_world_t *world, ecs_entity_t parent, ecs_entity_t canvas, int2 pixel_position, int2 size, float2 anchor, const char* text, int font_size, int header_margins, unsigned char layer, int2 parent_pixel_position_global, int2 parent_pixel_size, unsigned char is_close_button, int2 canvas_size) {
