...
ecs_entity_t spawn_element(ecs_world_t *world, const ecs_entity_t prefab, const ecs_entity_t canvas, const ecs_entity_t parent, int2 pixel_position, const int2 pixel_size, const float2 anchor, const unsigned char layer, const color element_color, const int2 parent_pixel_position_global, const int2 parent_pixel_size) {
