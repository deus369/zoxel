...
#define chunk_lod_state_dirty 1
...
#define chunk_lod_state_vox_blocks_spawn_5 11
#define chunk_lod_state_vox_blocks_spawn_6 12
#define chunk_lod_state_vox_blocks_spawn_7 13
#define chunk_lod_state_vox_blocks_spawn_8 14*/

#define chunk_lod_state_end 15
