const int max_chunks_build_per_frame = 16; // terrain chunks built per frame
...
const double real_terrain_frequency = 0.003216; //  0.013216; //  0.008216; // 0.004216; // 0.026216
