...
void spawn_prefabs_terrain(ecs_world_t *world) {
    ...
    prefab_chunk_height = spawn_prefab_terrain_chunk_octree(world, terrain_chunk_size);
    prefab_terrain_chunk_flat = spawn_prefab_terrain_chunk_octree(world, terrain_chunk_size);
