...
void test_raycast(ecs_world_t *world, const Keyboard *keyboard, const ecs_entity_t realm, const ecs_entity_t player) {
    ...
    if (keyboard->_1.pressed_this_frame) set_player_voxel_ray(world, realm, player, 0, 1, 1);
    if (keyboard->_2.pressed_this_frame) set_player_voxel_ray(world, realm, player, 0, 0, 2);
}
