...
void spawn_line2D_square(ecs_world_t *world, const float2 point, const float2 size, const float thickness, const double life_time, const color_rgb line_color) {
