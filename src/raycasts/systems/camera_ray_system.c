...
void calculate_new_frustum(ecs_world_t *world, const ecs_entity_t e, const float camera_far, double3 *corners) {
        ...
        const FieldOfView *fieldOfView = zox_get(e, FieldOfView)
        ...
        calculate_perspective_projection_matrix(&projection_matrix, aspect_ratio, cameraNearDistance->value, camera_far, fieldOfView->value);
