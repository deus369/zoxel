...
void define_systems_input(ecs_world_t* world) {
    // resets
    zox_system(ZevicePointerResetSystem, zox_pipelines_devices_reset, [out] ZevicePointer, [out] ZevicePointerOld)
    zox_system(ZeviceButtonResetSystem, zox_pipelines_devices_reset, [out] ZeviceButton)
    zox_system(ZeviceFingerResetSystem, zox_pipelines_devices_reset, [in] ZevicePointerOld, [out] ZevicePointerPosition, [out] ZevicePointerDelta, [none] Finger)
