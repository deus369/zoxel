...
void collide_with_chunk_d3(
    ...
    const int position_vox_last_d1 = real_position_to_voxel_position_dim(position_last_d1, scale);
    const int position_vox_last_d2 = real_position_to_voxel_position_dim(position_last_d2, scale);
    const int position_vox_last_d3 = real_position_to_voxel_position_dim(position_last_d3, scale);
    const int position_vox_d1 = real_position_to_voxel_position_dim(position_d1, scale);
    const int position_vox_d2 = real_position_to_voxel_position_dim(position_d2, scale);
    const int position_vox_d3 = real_position_to_voxel_position_dim(position_d3, scale);
...
void collide_with_chunk_d2(
    ...
    position_d1 += offset_d1;
    position_d2 += offset_d2;
    const int position_vox_last_d1 = real_position_to_voxel_position_dim(position_last_d1, terrain_scale);
    const int position_vox_last_d2 = real_position_to_voxel_position_dim(position_last_d2, terrain_scale);
    const int position_vox_d1 = real_position_to_voxel_position_dim(position_d1, terrain_scale);
    const int position_vox_d2 = real_position_to_voxel_position_dim(position_d2, terrain_scale);
...
void collide_with_chunk(
    ...
    const int position_vox_last_d = real_position_to_voxel_position_dim(position_last_d, terrain_scale);
    const int position_vox_d = real_position_to_voxel_position_dim(position_d, terrain_scale);
...
#define handle_collision_axis(d, offset, is_negative)\
    collide_with_chunk(world, \
        ...
        // handle_collision_axisf(y, offset_left, 1);
        // handle_collision_axisf(y, offset_right, 0);

        // double axis collision, fours sides per two axis
        /*handle_collision_axis_d2(x, z, offset_left.x, offset_left.z, 1, 1)
         h andle_collision_axis_d2(x, z, offset_right.x, offset_left.z, 0, 1)                          *
