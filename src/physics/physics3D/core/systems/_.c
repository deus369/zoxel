...
void define_systems_physics3D(ecs_world_t *world) {
    zox_system(Velocity3DSystem, zox_pip_physics, [out] transforms3.d.Position3D, [in] core.physics3.d.Velocity3D)
    zox_system(Omega3DSystem, zox_pip_physics, [in] Omega3D, [out] transforms3.d.Rotation3D)
    ...
    zox_system(Position3DBoundsSystem, zox_pip_physics, [in] generic.Position3DBounds, [in] generic.Bounds3D, [out] transforms3.d.Position3D) // EcsPostUpdate - move to collisions maybe?
}