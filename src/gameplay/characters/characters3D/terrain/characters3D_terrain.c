...
zox_system_1(Characters3DSpawnSystem, zox_pip_mainthread, [in] ChunkLodDirty, [in] ChunkOctree, [in] ChunkPosition, [in] RenderLod, [in] RenderDisabled, [out] EntityLinks, [none] terrain.TerrainChunk)
