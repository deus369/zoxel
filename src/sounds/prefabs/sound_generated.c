...
ecs_entity_t spawn_sound_generated(ecs_world_t *world, const ecs_entity_t prefab, const byte instrument_type, const float frequency, const float sound_length, const float sound_volume) {
    if (!prefab) {
