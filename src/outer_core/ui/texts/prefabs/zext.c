...
ecs_entity_t spawn_zext(ecs_world_t *world, ecs_entity_t parent, int2 position, float2 anchor, const char* text, int font_size)
{
    ...
    initialize_ui_components(world, e, parent, position, zext_size, anchor);
