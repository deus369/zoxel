...
ecs_entity_t spawn_elementbar2D_front(ecs_world_t *world, const ecs_entity_t canvas, const ecs_entity_t parent, const int2 parent_position, const int2 parent_size, const int2 canvas_size, const byte layer, const byte render_disabled, const color front_color) {
    const byte margin = 6;
