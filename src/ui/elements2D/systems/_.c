...
void define_systems_elements2D(ecs_world_t *world) {
    ...
    zox_system(ScrollbarSystem, EcsPostUpdate, [none] ScrollbarButton, [in] elements.core.DraggableState, [in] layouts2.d.PixelPosition, [in] layouts2.d.PixelSize, [in] hierarchys.ParentLink)
    zox_system(Elementbar2DSystem, EcsPostUpdate, [in] elements.core.ElementBar, [in] elements.core.ElementBarSize, [in] hierarchys.Children, [in] layouts2.d.PixelSize, [none] Elementbar2D)
