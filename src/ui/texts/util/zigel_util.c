int get_zext_max_x(const unsigned char *data, const int length) {
    int x = 0;
    int max_x = 0;
...
int get_zext_max_y(const unsigned char *data, const int length) {
    int y = 1;
    for (int i = 0; i < length; i++) {
...
int get_zext_x(const unsigned char *data, const int length, const int data_index) {
    int x = 0;
...
int get_zext_y(const unsigned char *data, const int length, const int data_index) {
    int y = 0;
    for (int i = 0; i < data_index; i++) {
        if (data[i] == zox_char_newline && i != length - 1) y++;
    }
...
int calculate_total_zigels(const unsigned char *data, const int length) {
    int count = 0;
    for (int i = 0; i < length; i++) {
...
unsigned char calculate_zigel_index(const unsigned char *data, const int length, const int spawn_index) {
    int j = 0;
    for (int i = 0; i < length; i++) {
        if (data[i] != zox_char_newline) {
...
int calculate_zigel_data_index(const unsigned char *data, const int length, const int spawn_index) {
    int j = 0;
    for (int i = 0; i < length; i++) {
        if (data[i] != zox_char_newline) {
...
int2 calculate_zext_size(const unsigned char *data, const int length, const unsigned char font_size, const byte2 padding, const unsigned char line_padding) {
...
int2 calculate_zigel_position(const unsigned char *data, const int length, const int data_index, const unsigned char font_size, const unsigned char text_alignment, const byte2 padding, const unsigned char line_padding) {
...
void set_zigel_position(ecs_world_t *world, const ZextData *zextData, const ecs_entity_t e, const int data_index, const int font_size, const unsigned char text_alignment, const byte2 text_padding, float2 anchor, const unsigned char zigels_count, const int2 parent_position, const int2 parent_size, const int2 canvas_size) {
