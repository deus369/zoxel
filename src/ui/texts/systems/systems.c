...
void define_systems_texts(ecs_world_t *world) {
    ...
    zox_system_1(ZextUpdateSystem, EcsOnUpdate, [in] TextData, [in] TextSize, [in] TextPadding, [in] Layer2D, [in] CanvasPosition, [in] PixelSize, [in] MeshAlignment, [in] FontOutlineColor, [in] FontFillColor, [in] FontThickness, [in] ZextDirty, [out] RenderDisabled, [out] Children, [none] Zext, [none] Text2D)
