...
void define_systems_texts(ecs_world_t *world) {
    ...
    if (!headless) {
        ...
        zox_system(ZextBackgroundSystem, zox_pipelines_zext_backgrounds, [none] Zext, [in] texts.ZextDirty, [in] texts.TextData, [in] texts.TextSize, [in] TextPadding, [in] rendering.MeshAlignment, [in] elements.core.CanvasLink, [out] layouts2.PixelSize, [out] textures.core.TextureSize, [out] textures.core.GenerateTexture, [out] rendering.core.MeshVertices2D, [out] rendering.MeshDirty)
    }
}