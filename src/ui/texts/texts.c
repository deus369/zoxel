...
zox_begin_module(Zexts)
    ...
    zox_system_1(ZextUpdateSystem, EcsOnUpdate, [in] TextData, [in] TextSize, [in] TextPadding, [in] Layer2D, [in] CanvasPosition, [in] PixelSize, [in] MeshAlignment, [in] FontOutlineColor, [in] FontFillColor, [in] FontThickness, [in] ZextDirty, [out] RenderDisabled, [out] Children, [none] Zext)
    if (!headless) zox_system(ZextParentBackgroundSystem, zox_pipelines_zext_backgrounds, [none] Zext, [in] ZextDirty, [in] TextData, [in] TextSize, [in] TextPadding, [in] MeshAlignment, [in] CanvasLink, [in] ParentLink)
    if (!headless) zox_system(ZextBackgroundSystem, zox_pipelines_zext_backgrounds, [none] Zext, [in] ZextDirty, [in] TextData, [in] TextSize, [in] TextPadding, [in] MeshAlignment, [in] CanvasLink, [out] PixelSize, [out] TextureSize, [out] GenerateTexture, [out] MeshVertices2D, [out] MeshDirty)
