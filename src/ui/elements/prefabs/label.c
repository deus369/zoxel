...
/*ecs_entity_t spawn_label(ecs_world_t *world, ecs_entity_t prefab, ecs_entity_t parent, ecs_entity_t canvas, int2 position, float2 anchor,  const char* text, int font_size, unsigned char alignment, unsigned char layer, int2 parent_pixel_position_global, int2 parent_pixel_size) {
