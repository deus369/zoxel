...
void define_systems_elements3D(ecs_world_t *world) {
    ...
    zox_system_1(Text3DResizeSystem, EcsOnUpdate, [in] TextData, [in] TextSize, [in] TextPadding, [in] Layer2D, [in] CanvasPosition, [in] PixelSize, [in] MeshAlignment, [in] FontOutlineColor, [in] FontFillColor, [in] FontThickness, [in] ZextDirty, [out] RenderDisabled, [out] Children, [none] zexts.Zext, [none] Text3D)
}