void set_element_layers_auto(ecs *world, const entity e, const byte layer) {
...
void set_element_layers(ecs *world, const entity e, const byte window_layer) {
    if (!zox_valid(e)) return;
...
byte get_highest_layer(ecs *world, const entity e, const byte layer) {
