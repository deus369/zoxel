...
void define_ui_data(ecs_world_t *world) {
...
void define_ui_systems(ecs_world_t *world) {
...
void initialize_module_ui(ecs_world_t *world) {
    define_ui_data(world);
    define_ui_systems(world);
